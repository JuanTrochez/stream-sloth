...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { date_naissance: @test.date_naissance, nom: @test.nom, prenom: @test.prenom } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { date_naissance: @test.date_naissance, nom: @test.nom, prenom: @test.prenom } }
